...
import EvidencePreview from './evidence-view'
  ...
  `}</style>
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          {/* <CardDescription>{complaintData.type} - Submitted on {complaintData.date}</CardDescription> */}
<Badge variant={complaintData.status === 'INCOMPLETEFORM' ? 'destructive' : 'default'}>
      ...
      {/* <CardFooter>
        <Button asChild variant="outline">
          <Link href="/complaints">Back to All Complaints</Link>
        </Button>
      </CardFooter> */}
    </Card>
  )
